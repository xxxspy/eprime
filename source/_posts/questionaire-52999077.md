...
tags: [问卷互填, 问卷调查填写, 问卷下载, 问卷代填, 问卷收集]
---
...
{% raw %}
<textarea rows="40" style="width: 100%;">1. 您认为买口香糖的各要素的重要性对比是：*[填空题]


2. 您认为下列三个品牌在以下项目的相对分值应该是：
项目一：包装*[填空题]
...
{% raw %}
<div class="qitem">
<h4>第1题:您认为买口香糖的各要素的重要性对比是：*[填空题][不能为空]</h4>
