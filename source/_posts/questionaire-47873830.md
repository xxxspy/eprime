---
title: "微信通讯录标签的问卷调查(问卷内容)"
date: 2019-10-20 16:52:19
tags: [问卷下载, 问卷星, 问卷模板, 问卷网, 问卷收集]
---
...
{% raw %}
<textarea rows="40" style="width: 100%;">1. 以下是微信通讯录的分组标签情况，括号中的是各个分组的人数。请您为每个分组可能引起社交焦虑的程度进行1-10打分。其中“1”表示某个分组可能引起的社交焦虑程度最低，10表示某个标签可能引起的社交焦虑程度最高。*[单选题]
1
2
3
4
...
{% raw %}
<div class="qitem">
<h4>第1题:以下是微信通讯录的分组标签情况，括号中的是各个分组的人数。请您为每个分组可能引起社交焦虑的程度进行1-10打分。其中“1”表示某个分组可能引起的社交焦虑程度最低，10表示某个标签可能引起的社交焦虑程度最高。*[单选题][必答题]</h4>
