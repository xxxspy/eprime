---
title: "移动端广告回避反应量表(问卷内容)"
date: 2019-09-12 13:25:47
tags: [问卷互填, 问卷设计, 刷问卷, 人工填问卷, 问卷收集]
---

### 问卷指导语

您好，这里是湖南大学大四本科课题研究问卷——“移动端广告回避反应量表”开发测试，本问卷填写时间约为5分钟，数据将仅用于量表研究，请您依据真实情况放心填写，感谢您的认真填写与支持，祝您生活愉快！
...
{% raw %}
<textarea rows="40" style="width: 100%;">1. 您对以下关于移动端广告认知的描述认同程度是：*[单选题]
0
1
2
3
...
{% raw %}
<div class="qitem">
<h4>第1题:您对以下关于移动端广告认知的描述认同程度是：*[单选题][必答题]</h4>
...
{% raw %}
<div class="qitem">
<h4>第2题:您对以下关于移动端广告回避情感的描述认同程度是：*[单选题][必答题]</h4>
...
{% raw %}
<div class="qitem">
<h4>第3题:您对以下关于移动端广告回避行为的描述认同程度是：*[单选题][必答题]</h4>
